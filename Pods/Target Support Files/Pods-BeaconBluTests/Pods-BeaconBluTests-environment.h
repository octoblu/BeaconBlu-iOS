...
// KCSIBeacon
#define COCOAPODS_POD_AVAILABLE_KCSIBeacon
#define COCOAPODS_VERSION_MAJOR_KCSIBeacon 1
#define COCOAPODS_VERSION_MINOR_KCSIBeacon 2
#define COCOAPODS_VERSION_PATCH_KCSIBeacon 0
